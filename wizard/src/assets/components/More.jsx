...
const More = () => {
  return (
    <div className="flex justify-center items-center w-full relative">
      ...
      <div className="px-10 md:ml-10 bg-gradient-to-r from-gray-900 via-amber-700 to-slate-900 text-white rounded-lg md:w-3/4 gap-80 md:flex w-full">
        
        <div className="md:py-8 text-white gap-4 py-2 md:px-8">
          <h1 className="text-2xl ">Create Tutorials in 3 Clicks.</h1>
          <p className="">
