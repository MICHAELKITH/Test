      ...
      <div className=" w-3/4 flex flex-col md:flex-row justify-center items-center p-4 mt-6 md:gap-10">
        <div className="mb-6 md:mb-0 flex justify-center items-center flex-col w-96 h-96  ">
          <img
            ...
            alt=""
          />
          <p className="font-open-sans text-2xl font-semibold leading-6 tracking-normal text-left mx-10 flex flex-col mt-5">
            1. Click Capture
            <span className="font-open-sans text-sm font-medium leading-5 tracking-normal text-left py-4">
