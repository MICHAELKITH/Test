      ...
      <div className="md:flex items-center justify-between bg-white py-4 md:px-10 px-7 ">
        ...
        >
          ...
          <div className=" md:flex-col-reverse md:flex  items-center gap-1 md:my-0 ">
            <button className="md:btn bg-black flex gap-2 text-white justify-center md:ml-8 font-semibold px-3 py-1 rounded duration-500 md:static md:mb-4">
              <img className="flex justify-center " src={chrome} alt="" />
              Install Wizardshots
            </button>
            <span className={`md:flex ${open ? 'flex-col' : 'flex-col-reverse'} md:items-center md:mt-0  `}>
              <img src={forever} alt="" />
            </span>
          </div>
        </ul>
